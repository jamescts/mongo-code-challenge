...
/* If we want to add support for a new payment gateway, all we need to do is
create a new gateway, adapter and controller and add them here. */
...
We could (and probably should!) also extend this list to include the functions and
specific endpoints each controller should bind, to make it even more configuration-driven.
*/
